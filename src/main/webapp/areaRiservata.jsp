...
<body id="page-top">
	...
	<!-- Footer-->
	<footer class="footer text-center bg-secondary text-white" id="footer">
		<div class="container px-4 px-lg-5">
			...
			<br>
			<p class="text-muted small mb-0">Sede legale: Piazza della Mostra 2, 39100 Bolzano &nbsp;&nbsp; Sede amministrativa: Viale Fulvio Testi 29, 20162 Milano</p>
